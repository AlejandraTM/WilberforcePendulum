//Poincaré Map simulation using the Verlat Velocity Method
...
//Functions of the Verlat Velocity Method 
...
int main()
{
	...
	k=0.005;
	section=0.0;
	//Variation of epsilon value from 0 to 1 in 0.1 steps size

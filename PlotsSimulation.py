...
t3,p13,v13,p23,v23=np.loadtxt("Sperturbation0.000000.txt",delimiter=';', usecols=(0,1,2,3,4),unpack=True)
...
while(option!=4):
	...
	if(option==0):
		fig, ax=plt.subplots()
		ax.plot(p13,p23,'b.', markersize=0.1,label="Pendulum")
		ax.set_xlabel('x')
		ax.set_ylabel('y')
		#plt.xlim(-0.5,0.5)
		#plt.ylim(-3.0,3.0)
		ax.grid(True)
		ax.set_title("Wilberforce Pendulum for $\epsilon=0.0$")
